                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <?PHP
                      $anexos = new anexosBL();
                      $registroAnexos= $anexos->obtenerAnexos($_SESSION['idusuario']);
                      foreach( $registroAnexos as $anexo ) {?>
                         <tr>
                          <td  data-order="asc"><?PHP echo $anexo->getNombre()?></td>
                          <td><?PHP echo $anexo->getNumero() ?></td>
                          <td><?PHP echo $anexo->getClave() ?></td>
                        </tr>   
